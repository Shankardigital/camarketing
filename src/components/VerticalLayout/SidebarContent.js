          ...
          <ul className="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <Link to="/cities">
                ...
                <span>{props.t("States & Cities")}</span>
              </Link>
            </li>
            <li>
              <Link to="/withdraw">
                <i className="bx bx-briefcase-alt-2"></i>
                <span>{props.t("Withdraw Requests")}</span>
              </Link>
            </li>
            ...
            <li>
              ...
              <ul className="sub-menu">
                <li>
                  <Link to="/customer_reports">{props.t("Customer Report")}</Link>
                </li>
                <li>
                  <Link to="/agentpayout">
                    {props.t("Agent Payout Report")}
                  </Link>
                </li>
                <li>
                  <Link to="/transactions">{props.t("Transactions Report")}</Link>
                </li>
              </ul>
            </li>
            ...
            <li>
              <Link to="/refering">
                <i className="bx bx-file"></i>
                <span>{props.t("Refering Policy")}</span>
              </Link>
            </li>
           {/* {sessionStorage.getItem("socialDrp") === 'false' ?(
            ""
           ):(
            <li style={{marginLeft:"25px"}} className="mt-2">
                <Button
                style={{width:"200px"}}
                  className="mt-3"
                  color="danger"
