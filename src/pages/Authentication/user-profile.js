...
const UserProfile = () => {
  ...
  const getAdmindata = async () => {
    const response = await addData("admin/getprofile")
  ...
  const fileChange = async (e)=>{
    ...
    try {
      const response = await addData("admin/updateprofilepic", dataArray)
      var _data = response.data
      toast.success(_data.message)
      getAdmindata()
    } catch (error) {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          {/* Render Breadcrumb */}
          <Breadcrumb title="CA Marketing" breadcrumbItem="Profile" />
