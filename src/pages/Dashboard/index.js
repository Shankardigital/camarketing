...
const Dashboard = props => {
  ...
  const reports = [
    ...
    { title: "Pending Leads", iconClass: "bx-archive-in", description: form.pendingLeads },
    {title: "Closed Leads",iconClass: "bx bx-user-check",description: form.successLeads},
    {title: "Rejected Leads",iconClass: "bx bx-user-x",description: form.rejectedLeads},
  ]
